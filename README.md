...
**Difficulty:** 10/10 &middot; **Task type:** Anomaly Detection / CV
...
```bash
git clone https://github.com/Sandyyy123/liora-07-industrial-anomaly.git
cd liora-07-industrial-anomaly
